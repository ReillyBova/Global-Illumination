...
CFLAGS= -resolution $(RESOLUTION) -aa 0 -v -lt 128 -ss 96 -tt 512 -st 512 -md 128 -threads 8 -it 480 -cache -global 500000 -gs 50 -gd .5 -no_caustic -no_transmissive -no_specular -dof 64 0.05 -no_indirect
