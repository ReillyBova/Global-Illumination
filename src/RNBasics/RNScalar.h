...
/* Thread safe RNG */
extern void RNInitThreadRandomness(void);
extern void RNSeedThreadRandomness(RNScalar seed = 0.0);
extern void RNClearThreadRandomness(void);
extern RNScalar RNThreadableRandomScalar(void);
